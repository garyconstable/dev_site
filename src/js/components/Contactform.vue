<template>
  <div name="contact">
    ...
    >
      ...
      <button type="submit" class="btn btn-submit btn-info w-75 p-3">
        Say Hello!
        <img src="/assets/images/ajax-loader.gif" v-if="show_loading == true" />
      </button>
    </form>

    <div v-if="show_thanks == true" class="contact-thanks">
      <form>
